            ...
            <div className="markdown">
                <Helmet
                    ...
                    meta={[
                        ...
                        {name: "twitter:creator", content: "@signoirn_public"},
                        {name: "twitter:title", content: title},
                        {name: "twitter:description", content: description || title},
                        {property: "og:title", content: title},
                        {property: "og:type", content: "article"},
                        {property: "og:url", content: `https://rn.netlify.com${post.path}`},
                ...
                <Flex mt={3} justify="center">
                    <ShareIcons title={title} desc={description} url={`https://rn.netlify.com${post.path}`}/>
                </Flex>
                ...
                <ReactDisqusThread
                    ...
                    title={post.title}
                    url={`https://rn.netlify.com${post.path}`}
                />
                }
            </div>
        )
